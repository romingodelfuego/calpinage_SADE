...
class BRAIN :   
    ...
    """    
    def createPiece(Name,ANGLE=0):
        match Name: 
            case "BE":
                return PIECE(Name,("EMBOITEMENT","BRIDE"))
            case "VANNE":
                return PIECE(Name,("BRIDE","BRIDE"))
            case "BU":
                return PIECE(Name,("BOUTMALE","BRIDE"))
            case "TÉ EMBOITEME":
                return PIECE(Name,("EMBOITEMENT","EMBOITEMENT","BRIDE"),propaConn3=[True,False,True])
            case "TÉ BRIDE":
                return PIECE(Name,("BRIDE","BRIDE","BRIDE"),propaConn3=[True,False,True])
            case "TUYAUX M-F":
                return PIECE(Name,("BOUTMALE","EMBOITEMENT"))
            case "TUYAUX M-M": #COUPE
                return PIECE(Name,("BOUTMALE","BOUTMALE"))
            case "COUDE EMBOITEMENT": 
                return PIECE(Name,("EMBOITEMENT","EMBOITEMENT"),ANGLE=ANGLE)
            case "COUDE BRIDE": 
                return PIECE(Name,("BRIDE","BRIDE"),ANGLE=ANGLE)
            case "CONE EMBOITEMENT":
                return PIECE(Name,("EMBOITEMENT","EMBOITEMENT"),propaConn2=[True,False,True])
            case "CONE BRIDE":
                return PIECE(Name,("BRIDE","BRIDE"),propaConn2=[True,False,True])
            case "TERMINAISON":
                return PIECE(Name,(["BRIDE"]))
            case "PLAQUE PLEINE":
                return PIECE(Name,(["BRIDE"]))
            case "BRANCHEMENT":
                return PIECE(Name,("EMBOITEMENT","EMBOITEMENT","BOUTMALE"),propaConn3=[True,False,False])
            case "MANCHON":
                return PIECE(Name,("EMBOITEMENT","EMBOITEMENT"))
            case "MANCHON TRANSITION":
                return PIECE(Name,("EMBOITEMENT","EMBOITEMENT"),propaConn2=[False,True,True])
            case "ADAPTATEUR DE BRIDE":
                return PIECE(Name,("EMBOITEMENT","BRIDE"),propaConn2=[False,True,True])
"""
###########################################################################################################################################
...
BRAIN.constructor(["TUYAUX M-M","TUYAUX M-F","TÉ EMBOITEMENT","BU","VANNE"])
